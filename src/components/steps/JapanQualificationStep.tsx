...
import { QIIScreeningTool } from './QIIScreeningTool'
...
export function JapanQualificationStep() {
  ...
  const [activeTab, setActiveTab] = useState<'screening' | 'form'>('screening')
  ...
  const needsSecuritiesAccount = (selectedCategories ?? []).some(c =>
    c === 'individual_100m' || c === 'individual_managing_partner'
  )
      ...
      {activeTab === 'screening' && (
        <div className="space-y-4">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-md text-xs text-blue-700">
            スクリーニングで要件充足を確認後、「FIEA申告フォーム」タブに進んでください。
          </div>
        </div>
      )}
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="space-y-3">
              <label className="checkbox-row flex items-start gap-3">
                <input type="radio" value="true" className="radio-input mt-0.5" {...register('isQII')} />
                <div>
              ...
              <label className="checkbox-row flex items-start gap-3">
                <input type="radio" value="false" className="radio-input mt-0.5" {...register('isQII')} />
                <div>
            ...
            <div className="space-y-3">
              <label className="checkbox-row flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">I/We declare that I/we am/are not, and will not become, a "Disqualified Investor" (排除措置対象者) under the FIEA, including anti-social forces (暴力団等) as defined under Japanese law.</p>
                </div>
              </label>
              ...
              <label className="checkbox-row flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">The capital contribution and any other payments required under the Agreement are not criminal proceeds or regulated under the Act on Punishment of Organized Crimes and Control of Crime Proceeds (Act No. 136 of 1999) or the Narcotics Special Provisions Act (Act No. 94 of 1991). I/We promise to immediately report to FGC if these regulations become applicable.</p>
                </div>
              </label>
              ...
              <label className="checkbox-row flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">The matters stated in the investor's certificate of registered incorporation matters (or other identification document) presented to FGC pursuant to Article 4(1) of the Act concerning Prevention of Transfer of Criminal Proceeds (Act No. 22 of 2007) and Articles 6 and 7 of its Enforcement Ordinance are correct.</p>
                </div>
              </label>
